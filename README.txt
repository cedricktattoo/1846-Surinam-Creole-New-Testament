...
7. If transcribing pages that do not yet have a directory, create the new directory using the naming convention used for currently created directories, such as for "02_da_evangelum_vo_st_matteus".  Since the book of Matthew is directory "02", make sure that the other books are ordered in the same sequence following "02".